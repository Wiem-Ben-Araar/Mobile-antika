...
public class ListLivraisonsUserForm extends BaseForm {

    public ListLivraisonsUserForm(Form previous,Resources res) throws IOException {
       ...
       Label sp14= new Label("Statut: " + "  " + p.getStatut());
          ...
          Label sp15= new Label("Adresse: " + "  " + p.getAdresse());
          sp15.getAllStyles().setFgColor(0x00000);
...
Button upd = new Button("Update");
                 ...
                 upd.addActionListener((evt) -> {
                  new EditLivraisonForm(this.getComponentForm(), res, p).show();
                    });
               
                 annuler.addActionListener((evt) -> {
                   ServiceLivraison.getInstance().annuler(p.getId());
                   
                    });
        addAll(sp15,spl2,sp13,sp14,annuler,upd)
                ;}
