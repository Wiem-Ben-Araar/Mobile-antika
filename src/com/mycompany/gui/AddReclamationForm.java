...
public class AddReclamationForm extends BaseForm {
     ...
     public AddReclamationForm(Form previous,Resources res,Produit p) {
        ...
        btnValider.addActionListener(new ActionListener() {
             ...
             public void actionPerformed(ActionEvent evt) {
                 if ((tfDescription.getText().length()==0)||(tfTitre.getText().length()==0)||(tfReponse.getText().length()==0)||(tfState.getText().length()==0))
                    Dialog.show("Alert", "Please fill all the fields", new Command("OK"));
                 else {
                    try {
                     
                        
                        if(ServiceReclamation.getInstance().addReclamation(tfDescription,tfTitre,tfState,tfReponse,p.getId()))
  ...
  Dialog.show("Success","Connection accepted",new Command("OK"));
      ...
      addAll(tfDescription,tfTitre,tfState,tfReponse,btnValider);
