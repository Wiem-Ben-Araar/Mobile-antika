...
public class StatistiquePieForm extends BaseForm {
    ...
    private double nbr_utilisateur = 50;
    private double nbr_avis = 25;
    ...
    public StatistiquePieForm(Resources res) {
        ...
        addTab(swipe, res.getImage("signup-background.jpg"), spacer1, "Bienvenue");
        ...
        RadioButton all = RadioButton.createToggle("Utilisateur", barGroup);

        all.setUIID("SelectBar");
        RadioButton popular = RadioButton.createToggle("Categorie Avis", barGroup);
    ...
    private void addButton(Image img, String title) {
        ...
        image.addActionListener(e -> {
            try {
                new AjoutAvisForm(Resources.getGlobalResources()).show();
            } catch (Exception exx) {
    ...
    public void createPieChartForm() {
        ...
        //stat utilisateur  par rapport aux avis  
        double total = nbr_utilisateur + nbr_avis;

        //values
        double prcntFeed = (nbr_utilisateur * 100) / total;

        double prcntRec = (nbr_avis * 100) / total;
        ...
        String[] messages = {
            "Statistique avis par rapport aux utilisateurs"
        };
    ...
    private CategorySeries buildDataset(String title, double prcntFeed, double prcntRec) {
        ...
        series.add("Avis", prcntRec);
        series.add("Utilisateur", prcntFeed);
