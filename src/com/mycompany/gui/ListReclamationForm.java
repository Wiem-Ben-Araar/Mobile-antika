...
public class ListReclamationForm extends BaseForm {
     public ListReclamationForm(Form previous,Resources res) throws IOException {
        ...
        list = new ArrayList<>();
        list = ServiceReclamation.getInstance().getAllReclamations();
        ...
        for ( Reclamation c : list) {
                  ...
                  Label i = new Label();
                         ...
                         Label sp2 = new Label("Produit Reclamé: " + "  " + c.getProduit().getNom());
         sp2.getAllStyles().setFgColor(0x00000);
  
         Label spl = new Label("Reclamation Titre : " + "  " + c.getTitre()); 
         spl.getAllStyles().setFgColor(0x00000);
         Label spl2 = new Label("Reclamation Description: " + "  " + c.getDescription());
         spl2.getAllStyles().setFgColor(0x00000);
  
         spl2.getAllStyles().setFgColor(0x00000);
 Label spDate = new Label("Reclamation Date: " + "  " + c.getDate());
    spDate.getAllStyles().setFgColor(0x00000);
    Label spReponse = new Label("Reponse: " + "  " + c.getReponse());
    spReponse.getAllStyles().setFgColor(0x00000);
         ...
         Button sup = new Button("Delete");
                ...
                sup.addActionListener((evt) -> {
                 ...
                 upd.addActionListener((evt) -> {
                        new EditReclamationForm(this.getComponentForm(),res,c.getId()).show();
                    });
                 
                   
                    
        addAll(sp2,spl,spl2,spDate,spReponse,sup,upd)
                ;}
