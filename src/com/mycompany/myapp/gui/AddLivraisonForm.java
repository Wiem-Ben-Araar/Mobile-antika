...
public class AddLivraisonForm extends BaseForm {
     ...
     public AddLivraisonForm(Form previous,Resources res,int idUser) {
             ...
             public void actionPerformed(ActionEvent evt) {
                 if ((tfAdresse.getText().length()==0))
                    ...
                    try {
                        ...
                        if(ServiceLivraison.getInstance().add(tfAdresse,idUser)){
                             Message m = new Message("Votre commande est confirmé!");
